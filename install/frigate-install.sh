...
msg_info "Installing Dependencies from jackharvest fork"
curl -fsSL https://raw.githubusercontent.com/jackharvest/frigate/dev/docker/main/install_deps.sh | bash
